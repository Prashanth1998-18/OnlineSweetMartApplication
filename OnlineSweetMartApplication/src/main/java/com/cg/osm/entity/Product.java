...
public Product(Integer prodid, @NotEmpty(message = "Product name cannot be empty") String prodName,
		@Positive(message = "Product cannot be zero or negative") double prodPrice,
		LocalDate expDate, Category category) {
	this.prodid = prodid;
...
public String toString() {
	return "Product [prodId=" + prodid + ", prodName=" + prodName + ", prodPrice=" + prodPrice + ", expDate=" + expDate
			 + "]";
}
