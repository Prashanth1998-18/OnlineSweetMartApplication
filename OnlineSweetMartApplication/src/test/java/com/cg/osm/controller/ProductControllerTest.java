...
import com.cg.osm.controller.ProductController;
...
public class ProductControllerTest {
	...
	void test_deleteCategory_ThrowCustomerNotFoundException() throws Exception {
		BDDMockito.given(cservice.deleteCategoryById(Mockito.anyInt())).willThrow(new CategoryNotFoundException("category not found"));
	...
	void test_updateCategory_ThrowCategoryNotFoundException() throws Exception {
		Category c=new Category(1,"type1");
		BDDMockito.given(cservice.updateCategory(Mockito.any(Category.class))).willThrow(new CategoryNotFoundException("category not found"));
		MockHttpServletRequestBuilder builder = MockMvcRequestBuilders.put("/category")
				.contentType(MediaType.APPLICATION_JSON_VALUE).accept(MediaType.APPLICATION_JSON)
				.characterEncoding("UTF-8").content(this.mapper.writeValueAsBytes(c));
	...
	void findProductByIdTest() throws Exception {
		...
		BDDMockito.given(cservice.findByCategoryId(1))
	...
	void findCategoryByIdTest_ThrowCategoryNotFoundException() throws Exception{
		BDDMockito.given(cservice.findByCategoryId(Mockito.anyInt())).willThrow(new CategoryNotFoundException("category not found"));
		mockmvc.perform(MockMvcRequestBuilders.get("/category/1"))
		.andExpect(status().isNotFound());
	}
	...
	void test_showAllProducts() throws Exception{
		...
		mockmvc.perform(MockMvcRequestBuilders.get("/product").contentType(MediaType.APPLICATION_JSON)).andExpect(status().isOk());
	}
	...
	void test_addProduct_ThrowCategoryNotFoundException() throws Exception {
		...
		LocalDate l = LocalDate.of(2021, 12, 15);
		Product p1=new Product(1,"prod1",200.0,l,c);
		BDDMockito.given(service.addProduct(Mockito.any(Product.class))).willThrow(new CategoryNotFoundException("Category not found"));
		MockHttpServletRequestBuilder builder = MockMvcRequestBuilders.post("/product")
				.contentType(MediaType.APPLICATION_JSON_VALUE).accept(MediaType.APPLICATION_JSON)
				.characterEncoding("UTF-8").content(this.mapper.writeValueAsBytes(p1));
		mockmvc.perform(builder).andExpect(status().isNotFound());
	...
	void test_updateProduct_ThrowProductNotFoundException() throws Exception {
		...
		LocalDate l = LocalDate.of(2021, 12, 15);
		Product p1=new Product(1,"prod1",200.0,l,c);
		BDDMockito.given(service.updateProduct(Mockito.any(Product.class))).willThrow(new ProductNotFoundException("Product not found"));
		MockHttpServletRequestBuilder builder = MockMvcRequestBuilders.put("/product")
				.contentType(MediaType.APPLICATION_JSON_VALUE).accept(MediaType.APPLICATION_JSON)
				.characterEncoding("UTF-8").content(this.mapper.writeValueAsBytes(p1));
	...
	void test_deleteProduct_ProductNotFoundException() throws Exception {
		BDDMockito.given(service.deleteProduct(Mockito.anyInt())).willThrow(new ProductNotFoundException("Product not found"));
		mockmvc.perform(MockMvcRequestBuilders.delete("/product/1"))
		.andExpect(status().isNotFound());
	}
	...
	void test_findProductById() throws Exception {
		...
		LocalDate l = LocalDate.of(2021, 12, 15);
		Product p1=new Product(1,"prod1",200.0,l,c);
		BDDMockito.given(service.findByProductId(1))
	...
	void test_findProductById_ThrowProductNotFoundException() throws Exception{
		BDDMockito.given(service.findByProductId(Mockito.anyInt())).willThrow(new ProductNotFoundException("Product not found"));
		mockmvc.perform(MockMvcRequestBuilders.get("/product/1"))
		.andExpect(status().isNotFound());
	}
	...
	void test_findProductByCategory() throws Exception {
		...
		List<Product> plist=new ArrayList<>();
		plist.add(p1);
		BDDMockito.given(service.findByCategoryId(1))
		.willReturn(plist);
	...
	void test_findProductByCategory_ThrowProductNotFoundException_CategoryNotFoundException() throws Exception {
		BDDMockito.given(service.findByCategoryId(Mockito.anyInt())).willThrow(new CategoryNotFoundException("Category not found"),new ProductNotFoundException("No products found"));
		mockmvc.perform(MockMvcRequestBuilders.get("/product/category/1"))
		.andExpect(status().isNotFound());
	}
